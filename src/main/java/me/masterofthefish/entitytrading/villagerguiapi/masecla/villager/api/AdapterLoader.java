...
public class AdapterLoader {
	...
	private EntityTrading plugin;

	private URLClassLoader classLoader = null;

	public AdapterLoader(EntityTrading plugin) {
		super();
		this.plugin = plugin;
	}
	...
	public void reflectivelyLoad()
		...
		String name = "me.masterofthefish.entitytrading.villagerguiapi.masecla.villager.adapters.instances.MerchantAdapter_" + getVersion();
